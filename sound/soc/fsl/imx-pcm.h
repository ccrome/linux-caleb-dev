 ...
 */
#define IMX_SSI_DMABUF_SIZE	(1024 * 1024)

#define IMX_DEFAULT_DMABUF_SIZE	(1024 * 1024)
#define IMX_SAI_DMABUF_SIZE	(1024 * 1024)
#define IMX_SPDIF_DMABUF_SIZE	(1024 * 1024)
#define IMX_ESAI_DMABUF_SIZE	(1024 * 1024)
